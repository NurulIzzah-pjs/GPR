...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($payment_method == 'Debit Card') {
        ...
        $stmt = $conn->prepare("INSERT INTO payments (payment_method, amount, name_on_card, expiration_date) VALUES (?, ?, ?, ?)");
        ...
        $stmt->bind_param("sdssss", $payment_method, $amount, $name_on_card, $expiration_date);
    } else {
